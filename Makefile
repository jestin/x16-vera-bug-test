...
8X88BPPT.BIN: 8x88bpp.xcf
	gimp -i -d -f -b '(export-vera "8x88bpp.xcf" "8X88BPPT.BIN" 0 8 8 8 1 1 1)' -b '(gimp-quit 0)'

8X88BPPM.BIN: 8x88bpp.tmx
	tmx2vera 8x88bpp.tmx -l l0 8X88BPPM.BIN

8X88BPP.PAL: 8X88BPPT.BIN
	cp 8X88BPPT.BIN.PAL 8X88BPP.PAL


16X88BPPT.BIN: 16x88bpp.xcf
	gimp -i -d -f -b '(export-vera "16x88bpp.xcf" "16X88BPPT.BIN" 0 8 16 8 1 1 1)' -b '(gimp-quit 0)'

16X88BPPM.BIN: 16x88bpp.tmx
	tmx2vera 16x88bpp.tmx -l l0 16X88BPPM.BIN

16X88BPP.PAL: 16X88BPPT.BIN
	cp 16X88BPPT.BIN.PAL 16X88BPP.PAL


8X168BPPT.BIN: 8x168bpp.xcf
	gimp -i -d -f -b '(export-vera "8x168bpp.xcf" "8X168BPPT.BIN" 0 8 8 16 1 1 1)' -b '(gimp-quit 0)'

8X168BPPM.BIN: 8x168bpp.tmx
	tmx2vera 8x168bpp.tmx -l l0 8X168BPPM.BIN

8X168BPP.PAL: 8X168BPPT.BIN
	cp 8X168BPPT.BIN.PAL 8X168BPP.PAL


16X168BPPT.BIN: 16x168bpp.xcf
	gimp -i -d -f -b '(export-vera "16x168bpp.xcf" "16X168BPPT.BIN" 0 8 16 16 1 1 1)' -b '(gimp-quit 0)'

16X168BPPM.BIN: 16x168bpp.tmx
	tmx2vera 16x168bpp.tmx -l l0 16X168BPPM.BIN

16X168BPP.PAL: 16X168BPPT.BIN
	cp 16X168BPPT.BIN.PAL 16X168BPP.PAL
